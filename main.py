...
from checkmate_logic import is_checkmate  
...
def draw_coordinates(screen):  
    ...
    for col in range(8):  
        col_label = font.render(chr(col + ord('a')), True, pygame.Color("black"))  
        screen.blit(col_label, (col * SQ_SIZE + SQ_SIZE // 3, HEIGHT - PANEL_HEIGHT + 10))  
